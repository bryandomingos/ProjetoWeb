...
<body>
    <div class="cadastro">
        ...
        <p>
            ...
            <input class="button" type="submit" value="Voltar" onclick="window.location.href='principal.php'">
        </p>
    </div>
